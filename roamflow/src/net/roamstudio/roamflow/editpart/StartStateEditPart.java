 ...
 *
 */
public class StartStateEditPart extends AbstractDiagramEditPart {
	...
	protected IFigure createFigure() {
		StartState model = (StartState)getModel();
...
//		Rectangle constraint = new Rectangle(0, 0, -1, -1);
		Rectangle constraint = ((StartState)getModel()).getContraint();
		if(constraint == null)
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if(evt.getPropertyName().equals(StartState.P_CONSTRAINT)){
			refreshVisuals();
		}
	}
